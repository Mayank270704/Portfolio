    ...
    <header className="fixed inset-x-0 top-0 z-50">
      <div className="border-b border-line/80 bg-void/70 backdrop-blur-xl">
        <div className="shell flex h-[var(--header-h)] items-center justify-between gap-6">
          ...
          >
            <span className="relative flex h-9 w-9 items-center justify-center rounded-lg border border-line-strong bg-surface font-display text-[0.8125rem] font-semibold tracking-tight text-fg">
              MN
          ...
          <button
            ...
            className="flex h-11 w-11 items-center justify-center rounded-lg border border-line-strong bg-surface text-fg-muted transition-colors hover:text-fg lg:hidden"
          >
